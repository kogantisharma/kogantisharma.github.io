...
<h1>Sri Koganti</h1>
<p class="lead">Senior Cloud &amp; Platform Engineer &mdash; Cork, Ireland</p>
...
[View my CV &rarr;](/cv/){: .btn} &nbsp; [LinkedIn &rarr;](https://www.linkedin.com/in/srikoganti){: .btn}
...
| | |
|---|---|
| **AWS** | EKS · CloudFront · Lambda · ECS · S3 · CloudWatch · RDS · Kinesis · Athena · SNS · SQS |
| **Containers** | Kubernetes · Docker · Helm |
| **IaC** | Terraform · Ansible · CloudFormation |
| **Networking** | Multi-region architecture · CDN · Disaster Recovery · Active-active |
...
| **Automation** | Python · Bash · Event-driven pipelines · ServiceNow integration |
| **SRE** | SLIs · SLOs · Error budgets · On-call · Incident management |
| **Git platform** | GitHub Cloud Platform (50,000+ repos at Fidelity) |

### Observability & Security

| | |
|---|---|
| **Monitoring** | Datadog · Splunk · Grafana/Prometheus · OpenTelemetry (OTEL) |
| **Security** | AWS GuardDuty · AWS Inspector · Prisma Cloud · Rapid7 |
| **Identity** | IAM · RBAC · Azure Active Directory |

---

## AI / MLOps — Actively Building

I'm currently upskilling and building projects at the intersection of cloud engineering
and AI. Focus areas:
