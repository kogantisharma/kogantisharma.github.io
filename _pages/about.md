...
The shift from infrastructure to MLOps is a natural evolution, not a pivot. The hardest problems
in AI deployment are **infrastructure problems**: reliable pipelines, reproducible environments,
observable model behaviour, and safe rollout strategies. I've been solving those problems for a decade.

I'm now combining that depth with hands-on ML engineering — building projects that demonstrate
